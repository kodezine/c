...
function(generate_mocks mock_headers working_dir perl_sh_dir create_mocks_dir)
    file(MAKE_DIRECTORY ${working_dir}_${PROJECT_NAME})
    foreach(element IN LISTS ${mock_headers})
        execute_process(
            COMMAND cp ${element} ${working_dir}_${PROJECT_NAME}
        )
    endforeach()
    file(GLOB MOCKRAW  ${working_dir}_${PROJECT_NAME}/*.h)
